/**
 * Route Groups - 화면 2
 * 파일: app/route-groups-guide/01-basic/(with-groups)/screen2.tsx
...
export default function WithGroupsScreen2() {
    ...
    <ThemedView style={styles.container}>
      <View style={styles.content}>
        <View style={[styles.header, { backgroundColor: colors.card }]}>
          ...
          <ThemedText style={styles.subtitle}>화면 2</ThemedText>
        </View>
          ...
          <View style={styles.comparison}>
            ...
            <View style={styles.comparisonRow}>
              ...
              <ThemedText style={styles.comparisonValue}>
                /01-basic/without-groups/screen2
              </ThemedText>
            </View>
            <View style={styles.comparisonRow}>
